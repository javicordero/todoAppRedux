              ...
              try {
                ...
                t.state !== j &&
                  ...
                  (t.type == R || (t.data && t.data.isPeriodic)
                    ...
                    : ((t.runCount = 0), this._updateTaskCount(t, -1), P && t._transitionTo(j, X, j))),
                  (G = G.parent),
                  (te = K)
              }
            }
        ...
        class T {
          constructor(p, t, o) {
            ...
            ;(y || (t && t._hasTaskZS)) &&
              ...
              o.onScheduleTask ||
                ((this._scheduleTaskZS = g), (this._scheduleTaskDlgt = t), (this._scheduleTaskCurrZone = this.zone)),
              o.onInvokeTask ||
                ((this._invokeTaskZS = g), (this._invokeTaskDlgt = t), (this._invokeTaskCurrZone = this.zone)),
              o.onCancelTask ||
                ((this._cancelTaskZS = g), (this._cancelTaskDlgt = t), (this._cancelTaskCurrZone = this.zone)))
          }
          fork(p, t) {
          ...
          invokeTask(p, t, o, y) {
            return this._invokeTaskZS
              ? this._invokeTaskZS.onInvokeTask(this._invokeTaskDlgt, this._invokeTaskCurrZone, p, t, o, y)
        ...
        function G(l, s, a) {
          ...
          if (l[d] === X) {
            ...
            if (s !== Y && a instanceof t && a.hasOwnProperty(d) && a.hasOwnProperty(L) && a[d] !== X)
              ...
              const C = l[L]
              if (
                ((l[L] = a), l[z] === z && s === A && ((l[d] = l[q]), (l[L] = l[j])), s === Y && a instanceof Error)
              ) {
      ...
      function Tt(e, n, i) {
        const r = (i && i.add) || Se,
          ...
          S = function (E, d, L) {
            ...
            const z = E.callback
            'object' == typeof z && z.handleEvent && ((E.callback = (q) => z.handleEvent(q)), (E.originalDelegate = z)),
              E.invoke(E, d, [L])
            const j = E.options
            j &&
              'object' == typeof j &&
            ...
            g &&
              ...
              c.forEach(function (m) {
                ...
                if (D.hasOwnProperty(m)) {
                  ...
                  Z && Z.value
                    ? ((Z.value = e.wrapWithCurrentZone(Z.value, S)), e._redefineProperty(g.prototype, m, Z))
              ...
              if ('function' == typeof S[0]) {
                ...
                S[0] = function () {
                  try {
                    ...
                    D.isPeriodic ||
                      ('number' == typeof D.handleId ? delete f[D.handleId] : D.handleId && (D.handleId[Ne] = null))
                  }
                }
                ...
                'number' == typeof D ? (Z = f[D]) : ((Z = D && D[Ne]), Z || (Z = D)),
                  Z && 'string' == typeof Z.type
                    ? 'notScheduled' !== Z.state &&
                      ...
                      ('number' == typeof D ? delete f[D] : D && (D[Ne] = null), Z.zone.cancelTask(Z))
                    : T.apply(e, S)
              }
          ))
      }
